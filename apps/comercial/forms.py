...
class FormTruck(forms.ModelForm):
    class Meta:
        model = Truck
        fields = ['license_plate', 'num_axle', 'year', 'truck_model', 'drive_type', 'plan', 'contact_phone',
                  'certificate', 'nro_passengers', 'engine', 'chassis', 'color', 'fuel_type', 'owner', 'condition_owner',
                  'technical_review_expiration_date', 'soat_expiration_date']
        labels = {
            'license_plate': 'Placa :',
            'num_axle': 'N de Ejes :',
            ...
            'certificate': 'Certificado de habilitacion M.T.C:',
            'nro_passengers': 'Numero de asientos :',
            'engine': 'motor :',
            'chassis': 'chassis :',
            'color': 'color :',
            ...
            'technical_review_expiration_date': 'Fecha de expiracion de revisión técnica :',
            'soat_expiration_date': 'Fecha de expiracion del soat :',
        }
        ...
        widgets = {
            ...
            'nro_passengers': forms.TextInput(
                attrs={
                    'class': 'form-control',
...
class FormGuide(forms.ModelForm):
    class Meta:
        model = Guide
        fields = ['serial', 'code', 'status', 'minimal_cost', 'observation']
        labels = {'serial': 'Serie',
                  'code': 'Codigo',
                  'status': 'Estado',
