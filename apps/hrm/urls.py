...
urlpatterns = [
    ...
    # change company
    path('change_companies/', login_required(change_companies), name='change_companies'),
    # report
    path('get_expiration_report/', login_required(get_expiration_report), name='get_expiration_report'),
]
