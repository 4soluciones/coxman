...
class Employee(models.Model):
    ...
    license_expiration_date = models.DateField('Fecha de expiracion de licencia', null=True, blank=True)
...
class Subsidiary(models.Model):
    ...
    def get_short_name(self):
        department_cod = self.district.id[0:2]
        department = Department.objects.get(id=department_cod).description.replace('DEPARTAMENTO ', '')
        return department
...
class CompanyUser(models.Model):
    id = models.AutoField(primary_key=True)
    company_initial = models.ForeignKey(Company, related_name='initial', on_delete=models.SET_NULL, null=True, blank=True)
    company_rotation = models.ForeignKey(Company, related_name='rotation', on_delete=models.SET_NULL, null=True, blank=True)
    user = models.OneToOneField(User, verbose_name='Usuario', on_delete=models.CASCADE, null=True, blank=True)
...
#     serial_two = models.CharField('Serie de tickets para pasajes', max_length=4, null=True, blank=True)
#     serial_three = models.CharField('Serie para manifiesto de pasajes', max_length=4, null=True, blank=True)
#     serial = models.CharField('Serie para encomiendas', max_length=4, null=True, blank=True)
#     serial_fourth = models.CharField('Serie para manifiesto de encomiendas', max_length=4, null=True, blank=True)
#     correlative_serial_two = models.IntegerField('correlativo de tickets para pasajes', default=0)
#     correlative_serial = models.IntegerField('correlativo para encomiendas', default=0)
#     correlative_serial_three = models.IntegerField('correlativo para manifiesto de pasajes', default=0)
#     correlative_serial_fourth = models.IntegerField('correlativo para manifiesto de encomiendas', default=0)
#     short_name = models.CharField(max_length=100, null=True, blank=True)
#     original_name = models.CharField(max_length=100, null=True, blank=True)
#     serial_invoice_to_passenger = models.CharField('Serie de facturas para pasajes', max_length=4, null=True, blank=True)
#     serial_voucher_to_passenger = models.CharField('Serie de boletas para pasajes', max_length=4, null=True, blank=True)
#     correlative_of_invoices_to_passenger = models.IntegerField('correlativo de facturas para pasajes', default=0)
#     correlative_of_vouchers_to_passenger = models.IntegerField('correlativo de boletas para pasajes', default=0)
#
#     def __str__(self):
#         return '{} - {}'.format(self.company.short_name, self.subsidiary.short_name)
#
#     class Meta:
#         verbose_name = 'Sucursal Empresa'
#         verbose_name_plural = 'Sucursales Empresas'
...
class SubsidiaryCompany(models.Model):
    ...
    serial_two = models.CharField('Serie de tickets para pasajes', max_length=4, null=True, blank=True)
    correlative_serial_two = models.IntegerField('correlativo de tickets para pasajes', default=0)
    serial_invoice_to_passenger = models.CharField('Serie de facturas para pasajes', max_length=4, null=True,
                                                   blank=True)
    correlative_of_invoices_to_passenger = models.IntegerField('correlativo de facturas para pasajes', default=0)
    serial_voucher_to_passenger = models.CharField('Serie de boletas para pasajes', max_length=4, null=True, blank=True)
    correlative_of_vouchers_to_passenger = models.IntegerField('correlativo de boletas para pasajes', default=0)
    serial = models.CharField('Serie para tickets de encomiendas', max_length=4, null=True, blank=True)
    correlative_serial = models.IntegerField('correlativo para tickets de encomiendas', default=0)
    serial_invoice_to_commodity = models.CharField('Serie de facturas para encomiendas', max_length=4, null=True,
                                                   blank=True)
    correlative_of_invoices_to_commodity = models.IntegerField('correlativo de facturas para encomiendas', default=0)
    serial_voucher_to_commodity = models.CharField('Serie de boletas para encomiendas', max_length=4, null=True,
                                                   blank=True)
    correlative_of_vouchers_to_commodity = models.IntegerField('correlativo de boletas para encomiendas', default=0)
...
class UserSubsidiary(models.Model):
    OFFICE_CHOICES = (('V1', 'VENTANILLA 1'), ('V2', 'VENTANILLA 2'), ('V3', 'VENTANILLA 3'), ('V4', 'VENTANILLA 4'),)
    ROL_CHOICES = (('S', 'SUPER ADMIN'), ('A', 'ADMIN'), ('E', 'EDITOR'), )
    PRINTER_CHOICES = (('1', 'PRINTER1'), ('2', 'PRINTER2'), ('3', 'PRINTER3'), )
    id = models.AutoField(primary_key=True)
    subsidiary = models.ForeignKey('Subsidiary', on_delete=models.SET_NULL, null=True, blank=True)
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True)
    rol = models.CharField(max_length=2, choices=ROL_CHOICES, default='E', )
    office = models.CharField(max_length=2, choices=OFFICE_CHOICES, default='V1', )
    printer = models.CharField(max_length=2, choices=PRINTER_CHOICES, default='1', )

    def __str__(self):
        return str(self.id)

    class Meta:
        verbose_name = 'Sucursal Usuario'
        verbose_name_plural = 'Sucursal Usuarios'
